...
class Ui_lu_decompositionWindow(object):
    ...
    def calcClicked(self):
        ...
        self.results = calculate_lu(matrix, len(self.eqns))
    ...
    def retranslateUi(self, bisectionWindow):
        ...
        bisectionWindow.setWindowTitle(_translate("bisectionWindow", "LU Decomposition"))
        self.calculateBisectionBtn.setText(_translate("bisectionWindow", "Calculate LU Decomposition"))
...
if __name__ == "__main__":
    ...
    lu_decompositionWindow = QtWidgets.QMainWindow()
    ui = Ui_lu_decompositionWindow()
    ui.setupUi(lu_decompositionWindow)
    lu_decompositionWindow.show()
    sys.exit(app.exec_())
